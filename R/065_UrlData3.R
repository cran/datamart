#' UrlData3 -- unified access to WWW resources
#' 
...
#' getSlots("UrlData3")
#' 
#' @exportClass UrlData3
#' @name UrlData3-class
#' @rdname UrlData3-class
setClass(
  Class="UrlData3", 
...
#' @export
#' @rdname UrlData3-class
urldata3 <- function(resource, template, extract.fct=readLines, transform.fct=identity, clss="UrlData3", ...) {
...
#' @export
#' @docType methods
#' @aliases query query,UrlData3,character-method
setMethod(
  f="query",
  signature=c(self="UrlData3", resource="character"),
...
#' @export
#' @docType methods
#' @aliases queries queries,UrlData3-method
setMethod(
  f="queries",
  signature="UrlData3",
